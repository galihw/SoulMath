function Print91(no,d1,c1,d2,c2,d3,c3,d4,nourut){
	...
	function GetSoal4(){
		const SPLDV = MySPLDV4();
		//[modal,persen,bln,hasil];
		var modal=SPLDV[0];
		var persenrugi=SPLDV[1];
		var hasil=SPLDV[2];
	...
	function GetSoal6(){
		...
		var n2=SPLDV[4];
		var ntot=SPLDV[5];
		var pctbiaya=SPLDV[6];
		var pctuntung=SPLDV[7];
	...
	function GetSoal9(){
		const SPLDV = MySPLDV9();
		//[harga,neto,untung,harga,hargajual];
		var harga1=SPLDV[0];
		var neto=SPLDV[1];
		var pctuntung=SPLDV[2];
		var harga=SPLDV[3];
		var hargajual=SPLDV[4];
	...
	function GetSoal18(){
		const SPLDV = MySPLDV18();
		//[pinjaman,ArrPersen[0],bulan,perbulan];
		var pinjaman=SPLDV[0];
		var persen=SPLDV[1];
		var bulan=SPLDV[2];
		var perbulan=SPLDV[3];
	...
	function GetSoal19(){
		const SPLDV = MySPLDV19();
		//[hargaAwal,harga1,harga2,persen];
		var hargaAwal=SPLDV[0];
		var harga1=SPLDV[1];
		var harga2=SPLDV[2];
		var persen=SPLDV[3];
	...
	function GetSoal20(){
		const SPLDV = MySPLDV20();
		//[arPersen[no][0],arPersen[no][1],arLabel,tothargabeli,totharga,ct,mpern];
		var persenjual=SPLDV[0];
		var persendiskon=SPLDV[1];
		var hargaLabel=SPLDV[2];
		var tothargabeli=SPLDV[3];
		var totharga=SPLDV[4];
		var ct=SPLDV[5];
		var mpern=SPLDV[6];
	...
	function GetSoal21(){
		const SPLDV = MySPLDV21();
		//[berat,ArrPersen[ct],benar,ArrSalah];
		var berat=SPLDV[0];
		var persen=SPLDV[1];
		var benar=SPLDV[2];
		var ArrSalah=SPLDV[3];
	...
	function GetSoal22(){
		const SPLDV = MySPLDV22();
		//[HargaJual,persen,benar,ArrSalah];
		var HargaJual=SPLDV[0];
		var persen=SPLDV[1];
		var benar=SPLDV[2];
		var ArrSalah=SPLDV[3];
	...
	function GetSoal23(){
		const SPLDV = MySPLDV23();
		//[Awal,persen,Akhir,bulan,ArrSalah];
		var Awal=SPLDV[0];
		var persen=SPLDV[1];
		var Akhir=SPLDV[2];
		var benar=SPLDV[3];
		var ArrSalah=SPLDV[4];
	...
	function GetSoal26(){
		const SPLDV = MySPLDV26();
		//[Harga,HargaSatuan,Modal,Loyang,Untung,ArrSalah];
		var Harga=SPLDV[0];
		var HargaSatuan=SPLDV[1];
		var Modal=SPLDV[2];
		var Loyang=SPLDV[3];
		var Untung=SPLDV[4];
		var ArrSalah=SPLDV[5];
	...
	function GetSoal27(){
		const SPLDV = MySPLDV27();
		//[HBeli1kg,Nkg,HBeli,ArrPersen[0],HJual1kg,ArrSalah];
		var HBeli1kg=SPLDV[0];
		var Nkg=SPLDV[1];
		var HBeli=SPLDV[2];
		var Persen=SPLDV[3];
		var HJual1kg=SPLDV[4];
		var ArrSalah=SPLDV[5];
	...
	//dd1.innerHTML="<p>Bab 6 \u{2192} SPLDV Sosial </p>";
	dd1.innerHTML="";
	if(no==5){
